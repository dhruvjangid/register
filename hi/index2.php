...
<body class = "main">
    ...
    <div class="form">
        ...
        <form name="myForm" action="third.php" onsubmit="return validateForm()"   enctype= "multipart/form-data"><hr>
          ...
          <button  type = "submit"  id = "submit" onclick="errorMessage()">Submit</button>
